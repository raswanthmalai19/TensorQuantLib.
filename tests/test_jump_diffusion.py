...
class TestMertonJumpDiffusion:
    ...
    def test_mc_matches_analytic(self):
        ...
        mc = merton_jump_price_mc(S, K, T, r, sigma, lam, mu_j, sigma_j,
...
class TestKouJumpDiffusion:
    ...
    def test_positive_price(self):
        price = kou_jump_price_mc(100, 100, 1.0, 0.05, 0.2,
                                  lam=1.0, p=0.5, eta1=10.0, eta2=5.0,
    ...
    def test_upward_bias_increases_call(self):
        ...
        c_low = kou_jump_price_mc(100, 120, 0.5, 0.05, 0.2,
                                  lam=2.0, p=0.2, eta1=5.0, eta2=5.0,
                                  n_paths=200_000, seed=42)
        c_high = kou_jump_price_mc(100, 120, 0.5, 0.05, 0.2,
                                   lam=2.0, p=0.8, eta1=5.0, eta2=5.0,
                                   n_paths=200_000, seed=42)
        assert c_high > c_low

    def test_higher_intensity_fatter_tails(self):
        """Higher jump intensity → higher OTM call price."""
        c_low = kou_jump_price_mc(100, 130, 0.5, 0.05, 0.2,
                                  lam=0.5, p=0.5, eta1=10.0, eta2=5.0,
                                  n_paths=100_000, seed=42)
        c_high = kou_jump_price_mc(100, 130, 0.5, 0.05, 0.2,
                                   lam=5.0, p=0.5, eta1=10.0, eta2=5.0,
                                   n_paths=100_000, seed=42)
        assert c_high > c_low
