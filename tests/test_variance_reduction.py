...
class TestAntithetic:
    ...
    def test_stderr_returned(self):
        _, stderr = bs_price_antithetic(100, 100, 1.0, 0.05, 0.20, n_paths=100_000, seed=0, return_stderr=True)
    ...
    def test_put_close_to_analytic(self):
        ...
        price = float(bs_price_antithetic(100, 100, 1.0, 0.05, 0.20, option_type="put", n_paths=100_000, seed=0))
        assert abs(price - eu_put) < 0.3


class TestControlVariates:
    def test_asian_cv_close_to_standard_mc(self):
        cv, _ = asian_price_cv(100, 100, 1.0, 0.05, 0.20, n_paths=50_000, seed=42, return_stderr=True)
    ...
    def test_cv_stderr_smaller_than_plain_mc(self):
        ...
        _, stderr_cv = asian_price_cv(100, 100, 1.0, 0.05, 0.20, n_paths=50_000, seed=42, return_stderr=True)
        _, stderr_plain = asian_price_mc(100, 100, 1.0, 0.05, 0.20, n_paths=50_000, seed=42, return_stderr=True)
